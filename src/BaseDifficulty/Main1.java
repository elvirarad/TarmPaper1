...
public class Main1 {
    public static void main(String[] args) {
        ...
        employee[0] = new Employee("Кайсаров", "Сергей", "Андреевич", 2, 320000);
        employee[1] = new Employee("Стрельцов", "Семен", "Петрович", 1, 280000);
        ...
        employee[7] = new Employee("Гареев", "Олег", "Григорьевич", 1, 290000);
        ...
        employeeService.calculationIndexationSalary(employee); //Индексация ЗП на 5%
        for (Employee i : employee){
            System.out.println(i);
        }
